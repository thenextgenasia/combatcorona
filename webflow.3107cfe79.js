! function(t) {
    ...
    i.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            /\.webflow\.io$/i.test(h) && u.hostname !== h && (s = !0), s && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "thenextgeneration.asia"), i = t("<img>").attr("src", "./logo.svg").attr("alt", "").css({ marginRight: "8px", width: "16px" }), a = t("<img>").attr("src", "").attr("alt", "Made by The Next Generation"), n.append(i, a), n[0]), d(), setTimeout(d, 500), t(r).off(l, f).on(l, f))
        }, n
    })
}, function(t, e, n) {
    "use strict";
